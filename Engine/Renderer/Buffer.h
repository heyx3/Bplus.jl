...
namespace Bplus::GL
{
    ...
    BETTER_ENUM(BufferHints_Frequency, uint8_t,
        //The most common use-case (e.x. most mesh data): set once and read many times.
        SetOnce_ReadOften,
    ...
    BETTER_ENUM(BufferHints_Purpose, uint8_t,
        //The most common use-case (e.x. most mesh data): set by the CPU, and read by the GPU.
        SetCPU_ReadGPU,
        //The buffer is set by the GPU, and read by the CPU.
        SetGPU_ReadCPU,

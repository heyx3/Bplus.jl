...
//The below file is taken from here: https://github.com/tcbrindle/span
//With the following modifications:
//   * Made a parameter name more correct
//   * Made TCB_SPAN_EXPECT able to be pre-defined (to BP_ASSERT in our case).
...
public:
    ...
    TCB_SPAN_CONSTEXPR11 span(pointer first_elem, pointer last_elem_exclusive)
        : storage_(first_elem, last_elem_exclusive - first_elem)
    {
        TCB_SPAN_EXPECT(extent == dynamic_extent ||
                        last_elem_exclusive - first_elem ==

//Source: https://github.com/VinGarcia/Simple-Iterator-Template/
//Released under the MIT license
//Modified to have more unique macro names.
//To use, just:
//     1. Define an iterator struct with the following methods:
//           * void begin(const MyCollection*)
//           * void end(const MyCollection*)
//           * void next(const MyCollection*)
//           * [optional] void prev(MyCollection*)
//           * T& get(MyCollection*)
//           * const T& get(const MyCollection*) const
//           * bool cmp(const ThisIteratorType& other) const
//     2. Immediately underneath the iterator struct definition, write something like the following macros:
//           VGSI_STL_TYPEDEFS(T);
//           VGSI_SETUP_ITERATORS(MyCollection, T&, ThisIteratorType);
//           [optional] VGSI_SETUP_REVERSE_ITERATORS(MyCollection, T&, ThisIteratorType);
